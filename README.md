...
│   └── reference_data_knn.pt     # Deep k-NN reference feature embeddings (0.3 MB)
├── models/
...
The **Deep k-NN (ICML 2022) with Triplet Margin Loss on ST-GCN embeddings** was selected as the champion model (`Train_Violence_STGCN_fold2.pth` + `reference_data_knn.pt`) for real-time live gating.
