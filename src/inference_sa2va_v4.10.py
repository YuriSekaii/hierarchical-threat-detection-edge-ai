...
import numpy as np
import torch
from transformers import AutoModel, AutoProcessor, AutoConfig, Qwen2Config

DEFAULT_MODEL_PATH = "ByteDance/Sa2VA-Qwen2_5-VL-7B"

DEFAULT_SYSTEM_PROMPT = (
    "<image>You are an expert security vision verification system. "
    "Your objective is to detect and segment only genuine handheld bladed weapons, knives, or blades "
    "physically grasped or brandished by a person. "
