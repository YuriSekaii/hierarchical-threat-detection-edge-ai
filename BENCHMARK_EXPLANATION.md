...
- **Output Files:**
  - CSV Summary: \esults/live_head_to_head_benchmark.csv\
  - Text Report: \esults/live_head_to_head_benchmark.txt\
- **Backbone Model Weights:** \	rained_models/Train_Violence_STGCN_fold2.pth\ (12,142,947 bytes)
- **Execution Command:**
  \\\powershell
...
A common source of confusion in the project's historical files was why Mahalanobis had a recorded score of **96.15%** in \alidation_results_micro.csv\, while k-NN recorded **83.12%** in \alidation_results_knn.csv\.
...
3. **The "Parametric Collapse" Misunderstanding:**
   ...
   - Our audit revealed this was caused by an un-updated reference file (\eference_data.json\ had not been recomputed when the joint-weighted Fold 2 model was trained on March 11).
